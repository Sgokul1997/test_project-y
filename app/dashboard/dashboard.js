...
angular.module('dashboard', ['ngRoute'])
  ...
  .controller('DashboardCtrl', ['$scope', '$http', '$location', '$window', '$rootScope', '$timeout', '$interval','$filter',
    function ($scope, $http, $location, $window, $rootScope, $timeout, $interval,$filter) {
